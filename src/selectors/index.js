...
export const selectMinPrice = state => state.form.Price_range_form.values.min_price_range;
export const selectMaxPrice = state => state.form.Price_range_form.values.max_price_range;
export const selectMinInitalPrice = state => state.form.Price_range_form.initial.min_price_range;
export const selectMaxInitalPrice = state => state.form.Price_range_form.initial.max_price_range;
